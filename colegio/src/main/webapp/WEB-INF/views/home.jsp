                      ...
                      <li class="sidebar-search">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a id="menuUsuarios" href="#"><i class="fa fa-user fa-fw"></i>Usuarios</a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-group fa-fw"></i>Grupos</a>
                                </li>
                            </ul>
                        </li>
                        </sec:authorize>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Cambio de Contrasena</h4>
                            </div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div id="cabeceraPincipal" class="panel-heading">
						</div>
					
						<div class="panel-body panel-principal">
							<div class="row">
								<div class="panel-body main-alerts" id="main-alerts">
								</div>
							</div>
							<div id="contenidoPrincipal" class="row">
